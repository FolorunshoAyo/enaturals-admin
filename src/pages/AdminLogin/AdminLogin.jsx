        ...
        <>
            ...
            <div className="loginContainer">
                <div className="loginBox">
                    ...
                    <form method="post" className="loginForm" onSubmit={handleSubmit(onSubmit)}>
                        <div className="loginFormGroup">
                            <label htmlFor="username" className="loginLabel">Username</label>
                            <input {...register("username", { required: "please provide a username" })} className="loginInput" id="username" placeholder="e.g Trixx..." />
                        ...
                        <div className="loginFormGroup">
                            ...
                            <div className="passwordContainer">
                                <input {...register("password", { 
                                    ...
                                    })} type={passwordVisibility? "text" : "password"} className="passwordInput" id="pwd" placeholder="Enter password..."/>
