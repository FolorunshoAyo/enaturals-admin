...
const TestimonialItem = ({id, caption, profile, handleDelete}) => {
    return (
        <div className="testimonialContent">
            <img src={profile.image} alt={"testimonial pic " + id} className="testimonialImg"/>
            <div className="testimonialInfo">
                <h3 className="testimonialTitle">{profile.name}</h3>
                <p className="testimonialDescription">{caption}</p>
